...
class GLUELoader(TaskLoaderBase):
    def _glue_preloader(self):
        ...
        raw_datasets['train'] = raw_datasets['train'].remove_columns("idx")
        raw_datasets['train'] = raw_datasets['train'].add_column("idx", [i+1 for i in range(len(raw_datasets['train']))])
